...
while True:
    ...
    for ckpt_folder in ckpt_folders:
        ...
        # 실행할 명령어 생성 및 실행
        for i, (ckpt_file, N, time_step_type, startpoint_type) in enumerate(tqdm(product(ckpt_files, int_lists, time_steps, startpoint_types))):
